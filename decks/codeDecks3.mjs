        ...
        // CON 2 SINERGIA DE PERSPECTIVA 7-10 CARTAS MAZO COMPETITIVO GRADO 3 15% DE 100
        ...
        for (const estado of estadosAleatorios) {
            ...
            if (cartaRepetida != undefined) {
                ...
                if ((i === 0 && mazo.length === 0) || (i === 0 && (mazo.length == 9 || mazo.length == 10)  )) {
                ...
                for (let i3 = 0; i3 < cantidadDeCartas1P; i3++) {
                    ...
                    // GENERO CARTAS DE LA PERSPECTIVA RESULTANTE, UTILIZANDO 1 NIVEL DEL ARRAY POR CADA ITERACIÓN Y LUEGO DESECHANDO EL NIVEL CON FILTER.
                        ...
                        // SI YA SE GENERARON LAS DOS PERSPECTIVAS CON SINERGIA Y CAMBIÉ DE ESTADO, 
                        // DEFINO LA CARTA QUE TENDRÁ REPETICIÓN OBLIGATORIA
